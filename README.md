...
## 3. Создание бота на своем языке
...
## 4. Отладка бота в типовом приложении на языке Node.js
...
Описание игровых объектов можно посмотреть [здесь](https://sbtatlas.sigma.sbrf.ru/wiki/pages/viewpage.action?pageId=3304956321)

### 4.1. Настройка типового приложения
...
### 4.2. Запуск приложения для отладки
...
### 4.4. Включение библиотек - по запросу
